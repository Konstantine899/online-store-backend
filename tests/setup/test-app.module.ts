import { RatingModel, TenantModel, UserModel } from '@app/domain/models';
...
@Module({
    imports: [
        ...
        SequelizeModule.forFeature([TenantModel, RatingModel, UserModel]), // Регистрируем модели для тестов
        ...
        // НЕ включаем ThrottlerModule для тестов
        ControllersModule,
        ServicesModule,
        RepositoriesModule,
        HealthModule,
