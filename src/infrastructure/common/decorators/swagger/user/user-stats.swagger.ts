...
export function GetUserStatsSwaggerDecorator() {
    return applyDecorators(
        ApiOperation({
            ...
            description: 'Возвращает подробную статистику по пользователям системы: общее количество, активные/заблокированные, VIP, подписчики рассылки, премиум пользователи, сотрудники, партнеры, оптовые покупатели и высокоценные клиенты.',
        }),
        ApiResponse({
            status: 200,
