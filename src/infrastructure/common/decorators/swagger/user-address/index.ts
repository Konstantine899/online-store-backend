export { GetUserAddressesSwaggerDecorator } from './get-addresses.swagger';
export { GetUserAddressSwaggerDecorator } from './get-address.swagger';
export { CreateUserAddressSwaggerDecorator } from './create-address.swagger';
